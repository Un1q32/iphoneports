...
llvm-strip ../bin/squidclient ../bin/purge ../sbin/squid basic_fake_auth basic_getpwnam_auth basic_ncsa_auth basic_radius_auth basic_smb_auth cachemgr.cgi digest_file_auth diskd ext_file_userip_acl ext_unix_group_acl log_file_daemon negotiate_wrapper_auth ntlm_fake_auth unlinkd url_fake_rewrite
