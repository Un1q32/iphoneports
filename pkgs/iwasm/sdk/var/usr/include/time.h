...
#define clock_getres __iphoneports_clock_getres
...
static int clock_getres(clockid_t clockid, struct timespec *res) {
  switch (clockid) {
  case CLOCK_REALTIME:
  case CLOCK_PROCESS_CPUTIME_ID:
#ifndef HIRES_THREAD_TIME
  case CLOCK_THREAD_CPUTIME_ID:
#endif
    res->tv_sec = 0;
    res->tv_nsec = 1000;
