...
cd src || exit 1
yacc parse.y
"$_TARGET-cc" -o doas -O2 doas.c env.c compat/execvpe.c compat/reallocarray.c y.tab.c compat/bsd-closefrom.c -lpam -Icompat -include compat/compat.h -DUSE_PAM -D__LINUX_PAM__ -DDOAS_CONF='"/var/usr/etc/doas.conf"'
