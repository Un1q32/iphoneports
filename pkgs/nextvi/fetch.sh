...
ver='b347a99c0678da06a7313074161aae22cf24494d'
if [ ! -f "$_DLCACHE/nextvi-$ver.tar.gz" ] ||
    [ "$(sha256sum "$_DLCACHE/nextvi-$ver.tar.gz" | awk '{print $1}')" != "17823a3a308f86f651ae5e65da58f352ef12d98839beb47d9bdcc7749189321b" ]; then
