...
(
cd source || exit 1
./configure --host="$_TARGET" --prefix=/usr --with-openssl --with-ca-fallback --disable-static --with-libssh2 --with-nghttp2
"$_MAKE" -j8
...
dpkg-deb -b --root-owner-group -Zgzip package curl-8.0.0.deb
