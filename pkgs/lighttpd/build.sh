...
(
cd src || exit 1
./configure --host="$_TARGET" --prefix=/var/usr --with-openssl --with-zlib --with-brotli --with-zstd --with-bzip2 --with-webdav-props PKG_CONFIG_PATH="$_SDK/var/usr/lib/pkgconfig"
"$_MAKE" -j8
