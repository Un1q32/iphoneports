...
(
cd src || exit 1
./configure --host="$_TARGET" --prefix=/var/usr --with-openssl --with-zlib --with-brotli --with-zstd --with-lua --with-sqlite --with-pam --with-webdav-props PKG_CONFIG_LIBDIR="$_SDK/var/usr/lib/pkgconfig"
"$_MAKE" -j8
