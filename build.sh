...
depcheck() {
    for dep in "$_TARGET-cc" "$_TARGET-sdkpath" ldid dpkg-deb fakeroot automake autoreconf m4 yacc ctags tar gzip bzip2 xz zstd ninja sed pgrep meson cmake curl git pkg-config; do
